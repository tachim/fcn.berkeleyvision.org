...
class VOCSegDataLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        self.h5f = h5py.File(self.data_path)
        self.indices = range(self.h5f['data'].shape[0])
    ...
    def forward(self, bottom, top):
        ...
        if self.random:
            ...
            self.idx = (self.idx + 1) % len(self.indices)
    ...
    def load_image(self, idx):
        ...
        """
        in_ = self.h5f['data'][idx].transpose((1, 2, 0))
        in_ *= 255
        in_ -= self.mean
